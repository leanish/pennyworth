 ...
 *
 * See `../../../specs/agentic-development/catalogit/specs/data-format.md` §Spine reference.
 */
 ...
 * source earns its keep. See ADR-0012 (`../../../specs/agentic-development/catalogit/docs/adr/`).
 */
