/**
 * `@leanish/runtime/testing` — in-memory fakes, fixture helpers, and
...
export { InMemoryCatalog, isEnabledForConsumer } from "@leanish/catalog-it";
export type { Project, ProjectSource, CatalogReadOnly, ConsumerCatalogView } from "@leanish/catalog-it";
