/**
 * `@leanish/runtime/lambda` — the focused bundle a downstream agent's
 * AWS Lambda entry module imports.
 *
 * The main `@leanish/runtime` entry exposes the full surface (handler
...
export { S3Catalog, type S3CatalogOptions, type CatalogBundle } from "@leanish/catalog-it";
